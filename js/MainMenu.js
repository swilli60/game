...
BasicGame.MainMenu.prototype = {
    ...
    create: function () {
		...
		this.text = this.game.add.text(this.game.world.centerX, this.game.world.centerY + 25, "Use the mouse to select two points that will form the basis for a line that will reveal part of the game board. There are four solid white circles, and you will hear a ding when a circle is found. The smaller and harder-to-find circles are worth more points! The player with the most points once all circles have been found wins!", this.style);
